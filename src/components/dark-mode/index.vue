<template>
  <div @click="toggleDark()">
    <svg v-if="!isDark" class="inline" viewBox="0 0 24 24" width="1.6em" height="1.6em" style="vertical-align: sub">
      <path
        fill="currentColor"
    ...
    <svg v-else class="inline" viewBox="0 0 24 24" width="1.6em" height="1.6em" style="vertical-align: sub">
      <path
        fill="currentColor"
